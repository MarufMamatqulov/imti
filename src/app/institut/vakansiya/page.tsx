      ...
      <section className="py-20 sm:py-28">
        <Container>
          <div className="grid grid-cols-1 gap-6 max-w-4xl mx-auto">
            {VACANCIES.map((vacancy, i) => (
              <Reveal key={vacancy.slug} delay={i * 0.06}>
                <div className="rounded-2xl border border-slate-100 bg-white p-7 sm:p-8 shadow-[0_2px_4px_rgba(16,24,40,0.04)] hover:shadow-[0_16px_40px_rgba(10,31,77,0.1)] transition-shadow duration-300">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-primary-50 text-primary-700 px-3.5 py-1.5 text-xs font-bold w-max">
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-t border-slate-100 pt-5">
          ...
          <Reveal className="mt-10 max-w-4xl mx-auto">
            <div className="rounded-2xl bg-primary-50 border border-primary-100 p-6 text-sm text-primary-900 text-center">
