...
export default function CtaSection() {
  return (
    <section className="py-20 sm:py-24">
      <Container>
        <Reveal>
          <div className="rounded-md bg-primary-950 px-8 py-14 sm:px-16 sm:py-16 text-center text-white">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              ...
              <Button href={SITE.socials.telegram} variant="outline-light" size="lg" icon={<Send className="h-4 w-4" />}>
                Telegram kanal
              </Button>
            </div>
          </div>
